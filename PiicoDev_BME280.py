...
class PiicoDev_BME280:
    ...
    def read_raw_data(self):
        ...
        while self._read16(0xF3) & 0x08:
            sleep_ms(1)
        raw_p = (
            (self._read8(0xF7) << 16) | (self._read8(0xF8) << 8) | self._read8(0xF9)
        ) >> 4
        raw_t = (
            (self._read8(0xFA) << 16) | (self._read8(0xFB) << 8) | self._read8(0xFC)
        ) >> 4
    ...
    def read_compensated_data(self):
        ...
        h = ((((raw_h << 14) - (self._H4 << 20) - (self._H5 * h)) + 16384) >> 15) * (
            (
                (
                    ((((h * self._H6) >> 10) * (((h * self._H3) >> 11) + 32768)) >> 10)
                    + 2097152
                )
                * self._H2
                + 8192
